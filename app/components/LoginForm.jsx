...
import loadingSyles from "../styles/Loading.module.css"
...
export default function LoginForm() {
    ...
    return (
        <>
            {loading && <span className={loadingSyles.loader}></span>}
            <form className={styles.auth_form} onSubmit={checkUser}>
                ...
                <button className={styles.auth_form__button}>Увійти</button>
            </form>
            {unauthorized && <p className={styles.unauthorized_error}>Користувач не існує. Перевірте введені дані або зареєструйтесь!</p>}
        </>
